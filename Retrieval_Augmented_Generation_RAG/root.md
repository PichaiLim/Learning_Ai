# RAG Pipeline
 1) [/] [ingestion.py](ingestion.py)            → ได้ raw file           [ingestion.md](ingestion.md)
 2) [/] [preprocessing.py](preprocessing.py)    → ได้ clean.md           [preprocessing.md](preprocessing.md)
 3) [/] [chunking.py](chunking.py)              → ได้ chunked.md         [chunking.md](chunking.md)
 4) [/] [embedding.py](embedding.py)            → ได้ embedding.md       [embedding.md](embedding.md)
 5) [-] [vector_store.py](vector_store.py)      → ได้ vector_store.md    [vector_store.md](vector_store.md)
 6) [-] [retriever.py](retriever.py)            → ได้ retriever.md       [retriever.md](retriever.md)
 7) [-] [generator.py](generator.py)            → ได้ generator.md       [generator.md](generator.md)
